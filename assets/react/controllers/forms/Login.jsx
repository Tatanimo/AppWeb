        ...
        <div className="space-y-6 ">
            ...
            <div className="w-full">
                {loading ? (
                    ...
                    <Button className="m-auto bg-blue-purple w-64 hover:opacity-75 hover:!bg-blue-purple"
                            onClick={() => onSubmit()}>Se connecter</Button>
                )}
            </div>
            <div className="flex justify-center items-center border-b border-b-black border-solid !mt-4 pb-3 mx-8">
                <a href="#"
                   className="text-sm text-center text-black hover:underline dark:text-cyan-500 ml-5">
                    Mot de passe oublié ?
                </a>
            </div>
            ...
            <div className="w-full text-center">
                <Button className="m-auto bg-blue-purple w-40 hover:opacity-75 hover:!bg-blue-purple"
                        onClick={() => setShowRegister(true)}>Créer un compte</Button>
            </div>
        </div>
    );
}

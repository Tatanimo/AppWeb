  ...
  return (
    <div className="space-y-6 ">
        ...
        <div className="w-full">
            ...
            <Button className="m-auto bg-blue-purple w-64 hover:opacity-75 hover:!bg-blue-purple" onClick={() => onSubmit()}>Créer un compte</Button>
            )}
        </div>
        ...
        <div className="w-full text-center">
            <Button className="m-auto bg-blue-purple w-40 hover:opacity-75 hover:!bg-blue-purple" onClick={() => setShowRegister(false)}>Se connecter</Button>
        </div>
    </div>
  )
}

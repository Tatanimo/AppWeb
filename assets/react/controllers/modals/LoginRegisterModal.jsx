...
export default function LoginRegisterModal({openModal, setOpenModal}) {
    ...
    return (
        <>
            <Modal className="[&>div>div]:bg-beige"
                   dismissible
                   show={openModal}
                   size="md"
                   popup
                ...
                <Modal.Body>
                    <div className="space-y-6 ">
                        ...
                        <div className="w-full text-center">
                            <Button className="m-auto bg-blue-purple w-64 hover:opacity-75 hover:!bg-blue-purple font-Roboto">Se
                                connecter</Button>
                        </div>
                        <div className="flex justify-between border-b border-b-black border-solid !mt-2 pb-3 mx-8">
                            <a href="#"
                               className="text-sm text-black hover:underline dark:text-cyan-500 ml-5">
                                Mot de passe oublié ?
                            </a>
                        </div>
                        ...
                        <div className="w-full text-center">
                            <Button className="m-auto bg-blue-purple w-40 hover:opacity-75 hover:!bg-blue-purple font-Roboto">Créer
                                un compte</Button>
                        </div>
                    </div>
                </Modal.Body>

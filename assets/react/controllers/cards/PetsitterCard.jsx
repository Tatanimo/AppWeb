...
function PetsitterCard({professional, dist}) {
  ...
  return (
    <a id="card-petsitter" className='mx-4 my-2 p-4 rounded-2xl border-8 border-[#F59C23] max-w-[416px] w-full cursor-pointer transition-all active:scale-90 hover:opacity-70' href={`/profil/professionnel/${professional.id}`}>

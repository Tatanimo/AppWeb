...
export default function Alerts({type, flash}) {
  ...
  return (
    <>
        {disable ? null : (
            <div className={`bg-${color}-100 border-l-4 border-${color}-500 text-${color}-700 p-4 w-fit m-4 animatecss ${bounce}`} role="alert">

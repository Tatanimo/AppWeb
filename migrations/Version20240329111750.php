 ...
 */
final class Version20240329111750 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE messages (id INT AUTO_INCREMENT NOT NULL, rooms_id VARCHAR(255) DEFAULT NULL, author_id INT NOT NULL, content LONGTEXT NOT NULL, publication_date DATE NOT NULL, INDEX IDX_DB021E968E2368AB (rooms_id), INDEX IDX_DB021E96F675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE rooms (reference VARCHAR(255) NOT NULL, PRIMARY KEY(reference)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

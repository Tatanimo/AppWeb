 ...
 */
final class Version20240521173146 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE appointments (id INT AUTO_INCREMENT NOT NULL, professional_id INT NOT NULL, animal_id INT NOT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL, INDEX IDX_6A41727ADB77003 (professional_id), INDEX IDX_6A41727A8E962C16 (animal_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE cities (id INT AUTO_INCREMENT NOT NULL, department_code VARCHAR(3) DEFAULT NULL, name VARCHAR(255) NOT NULL, zip_code INT DEFAULT NULL, latitude DOUBLE PRECISION DEFAULT NULL, longitude DOUBLE PRECISION DEFAULT NULL, insee_code VARCHAR(255) DEFAULT NULL, slug VARCHAR(255) DEFAULT NULL, INDEX IDX_D95DB16BD50F57CD (department_code), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE professionals (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, city_id INT NOT NULL, service_id INT NOT NULL, live_in VARCHAR(255) NOT NULL, price DOUBLE PRECISION NOT NULL, address VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, criteria JSON DEFAULT NULL, UNIQUE INDEX UNIQ_2DBE308EA76ED395 (user_id), INDEX IDX_2DBE308E8BAC62AF (city_id), INDEX IDX_2DBE308EED5CA9E6 (service_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE professionals_category_animals (professionals_id INT NOT NULL, category_animals_id INT NOT NULL, INDEX IDX_E7086B167E755BEF (professionals_id), INDEX IDX_E7086B163535CE26 (category_animals_id), PRIMARY KEY(professionals_id, category_animals_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE rooms (reference VARCHAR(255) NOT NULL, professional_id INT DEFAULT NULL, uuid VARCHAR(255) NOT NULL, PRIMARY KEY(reference)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE appointments ADD CONSTRAINT FK_6A41727ADB77003 FOREIGN KEY (professional_id) REFERENCES professionals (id)');
        $this->addSql('ALTER TABLE appointments ADD CONSTRAINT FK_6A41727A8E962C16 FOREIGN KEY (animal_id) REFERENCES animals (id)');
        ...
        $this->addSql('ALTER TABLE professionals ADD CONSTRAINT FK_2DBE308E8BAC62AF FOREIGN KEY (city_id) REFERENCES cities (id)');
        $this->addSql('ALTER TABLE professionals ADD CONSTRAINT FK_2DBE308EED5CA9E6 FOREIGN KEY (service_id) REFERENCES services_type (id)');
        $this->addSql('ALTER TABLE professionals_category_animals ADD CONSTRAINT FK_E7086B167E755BEF FOREIGN KEY (professionals_id) REFERENCES professionals (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE professionals_category_animals ADD CONSTRAINT FK_E7086B163535CE26 FOREIGN KEY (category_animals_id) REFERENCES category_animals (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE reviews ADD CONSTRAINT FK_6970EB0FDB77003 FOREIGN KEY (professional_id) REFERENCES professionals (id)');
        $this->addSql('ALTER TABLE schedules ADD CONSTRAINT FK_313BDC8EDB77003 FOREIGN KEY (professional_id) REFERENCES professionals (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE appointments DROP FOREIGN KEY FK_6A41727A8E962C16');
        ...
        $this->addSql('ALTER TABLE professionals DROP FOREIGN KEY FK_2DBE308E8BAC62AF');
        $this->addSql('ALTER TABLE professionals DROP FOREIGN KEY FK_2DBE308EED5CA9E6');
        $this->addSql('ALTER TABLE professionals_category_animals DROP FOREIGN KEY FK_E7086B167E755BEF');
        $this->addSql('ALTER TABLE professionals_category_animals DROP FOREIGN KEY FK_E7086B163535CE26');
        ...
        $this->addSql('ALTER TABLE reviews DROP FOREIGN KEY FK_6970EB0FDB77003');
        $this->addSql('ALTER TABLE schedules DROP FOREIGN KEY FK_313BDC8EDB77003');
        ...
        $this->addSql('DROP TABLE professionals_category_animals');

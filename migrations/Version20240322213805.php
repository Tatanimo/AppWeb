 ...
 */
final class Version20240322213805 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cities (id INT AUTO_INCREMENT NOT NULL, department_code VARCHAR(3) DEFAULT NULL, name VARCHAR(255) NOT NULL, zip_code VARCHAR(5) NOT NULL, insee_code VARCHAR(5) DEFAULT NULL, slug VARCHAR(255) DEFAULT NULL, INDEX IDX_D95DB16BD50F57CD (department_code), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE companies (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL, type VARCHAR(30) NOT NULL, adress VARCHAR(100) NOT NULL, zip_code VARCHAR(5) NOT NULL, city VARCHAR(50) NOT NULL, image VARCHAR(50) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

 ...
 */
final class Version20240320095830 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE articles (id INT AUTO_INCREMENT NOT NULL, users_id INT DEFAULT NULL, title VARCHAR(50) NOT NULL, content LONGTEXT NOT NULL, image VARCHAR(50) DEFAULT NULL, publication_date DATE DEFAULT NULL, state TINYINT(1) DEFAULT NULL, keyword VARCHAR(50) DEFAULT NULL, modification_date DATE DEFAULT NULL, slug VARCHAR(50) NOT NULL, INDEX IDX_BFDD316867B3B43D (users_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE cities (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL, postal_code VARCHAR(10) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE cities_companies (cities_id INT NOT NULL, companies_id INT NOT NULL, INDEX IDX_49B880FFCAC75398 (cities_id), INDEX IDX_49B880FF6AE4741E (companies_id), PRIMARY KEY(cities_id, companies_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE commentaries (id INT AUTO_INCREMENT NOT NULL, fk_user_id INT NOT NULL, posts_id INT NOT NULL, content LONGTEXT NOT NULL, publication_date DATE NOT NULL, number_like INT DEFAULT NULL, modification_date DATETIME DEFAULT NULL, INDEX IDX_4ED55CCB5741EEB9 (fk_user_id), INDEX IDX_4ED55CCBD5E258C5 (posts_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE companies (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL, type VARCHAR(30) NOT NULL, adress VARCHAR(100) NOT NULL, postal_code VARCHAR(10) NOT NULL, city VARCHAR(50) NOT NULL, image VARCHAR(50) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE messages (id INT AUTO_INCREMENT NOT NULL, rooms_id INT NOT NULL, author_id INT NOT NULL, content LONGTEXT NOT NULL, publication_date DATE NOT NULL, INDEX IDX_DB021E968E2368AB (rooms_id), INDEX IDX_DB021E96F675F31B (author_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE posts (id INT AUTO_INCREMENT NOT NULL, fk_user_id INT NOT NULL, content LONGTEXT NOT NULL, publication_date DATE NOT NULL, keyword VARCHAR(50) DEFAULT NULL, number_like INT DEFAULT NULL, state TINYINT(1) DEFAULT NULL, modification_date DATETIME DEFAULT NULL, INDEX IDX_885DBAFA5741EEB9 (fk_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `users` (id INT AUTO_INCREMENT NOT NULL, fk_company_id INT DEFAULT NULL, cities_id INT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, birthdate DATE NOT NULL, address VARCHAR(100) DEFAULT NULL, phone_number VARCHAR(20) DEFAULT NULL, iban VARCHAR(34) DEFAULT NULL, image VARCHAR(50) DEFAULT NULL, first_name VARCHAR(50) NOT NULL, last_name VARCHAR(100) NOT NULL, UNIQUE INDEX UNIQ_1483A5E9E7927C74 (email), INDEX IDX_1483A5E967F5D045 (fk_company_id), INDEX IDX_1483A5E9CAC75398 (cities_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE cities_companies ADD CONSTRAINT FK_49B880FFCAC75398 FOREIGN KEY (cities_id) REFERENCES cities (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE cities_companies ADD CONSTRAINT FK_49B880FF6AE4741E FOREIGN KEY (companies_id) REFERENCES companies (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE rooms ADD CONSTRAINT FK_7CA11A9664866755 FOREIGN KEY (fk_user1_id) REFERENCES `users` (id)');
        $this->addSql('ALTER TABLE rooms ADD CONSTRAINT FK_7CA11A967633C8BB FOREIGN KEY (fk_user2_id) REFERENCES `users` (id)');
